...
namespace Klevu\Frontend\Test\Integration\Logger;

use Klevu\Frontend\Logger\Logger as FrontendLoggerVirtualType;
...
/**
 * @covers FrontendLoggerVirtualType::class
...
class LoggerTest extends TestCase
{
    ...
    private const XML_PATH_LOG_LEVEL = 'klevu_frontend/developer/log_level_frontend';
    private const LOG_FILENAME_PATTERN = 'klevu-%s-frontend.log';
    ...
    protected function setUp(): void
    {
        ...
        $this->implementationFqcn = FrontendLoggerVirtualType::class; // @phpstan-ignore-line virtualType
